...
class person_strategy_strategytag extends DURCModel{
    ...
    protected static $rules = [
		...
		'strategy_id' => 'integer|present',
		'strategytag_id' => 'integer|present',
		'link_note' => 'nullable',
		'created_at' => 'present',
		'updated_at' => 'present',
	...
	public function getStrategytagIdAttribute($value)
	{
		$formatted_value = $value;
		return $formatted_value;
	}

	public function setStrategytagIdAttribute($value)
	{
		$formatted_value = DURC::formatForStorage('strategytag_id', 'int', $value, $this);
		$this->attributes['strategytag_id'] = $formatted_value;
	}
