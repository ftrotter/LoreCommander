...
lore.person_classofcreature_tag by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in person_classofcreature_tag.php 

*/

class person_classofcreature_tag extends DURCModel{

    

    
        // the datbase for this model
        protected $table = 'lore.person_classofcreature_tag';
...
/**
*	get the single person for this person_classofcreature_tag
*/
...
/**
*	get the single classofcreature for this person_classofcreature_tag
*/
...
/**
*	get the single tag for this person_classofcreature_tag
*/
	public function tag(){
...
}//end of person_classofcreature_tag