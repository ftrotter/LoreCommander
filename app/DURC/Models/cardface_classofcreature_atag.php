...
lore.cardface_classofcreature_atag by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in cardface_classofcreature_atag.php 

*/

class cardface_classofcreature_atag extends DURCModel{

    

    
        // the datbase for this model
        protected $table = 'lore.cardface_classofcreature_atag';
...
/**
*	get the single cardface for this cardface_classofcreature_atag
*/
...
/**
*	get the single classofcreature for this cardface_classofcreature_atag
*/
...
/**
*	get the single atag for this cardface_classofcreature_atag
*/
...
}//end of cardface_classofcreature_atag