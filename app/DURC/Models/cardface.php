...
class cardface extends DURCModel{
    ...
    protected static $rules = [
		...
		'is_color_green' => 'integer',
		'is_color_red' => 'integer',
		'is_color_blue' => 'integer',
		'is_color_black' => 'integer',
		'is_color_white' => 'integer',
		'is_colorless' => 'integer',
		'color_count' => 'integer',
		'is_color_identity_green' => 'integer',
		'is_color_identity_red' => 'integer',
		'is_color_identity_blue' => 'integer',
		'is_color_identity_black' => 'integer',
		'is_color_identity_white' => 'integer',
