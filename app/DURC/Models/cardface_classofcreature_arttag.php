...
lore.cardface_classofcreature_arttag by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in cardface_classofcreature_arttag.php 

*/

class cardface_classofcreature_arttag extends DURCModel{

    

    
        // the datbase for this model
        protected $table = 'lore.cardface_classofcreature_arttag';
...
/**
*	get the single cardface for this cardface_classofcreature_arttag
*/
...
/**
*	get the single classofcreature for this cardface_classofcreature_arttag
*/
...
/**
*	get the single arttag for this cardface_classofcreature_arttag
*/
	public function arttag(){
		return $this->belongsTo('App\arttag','arttag_id','id');
	}
...
}//end of cardface_classofcreature_arttag