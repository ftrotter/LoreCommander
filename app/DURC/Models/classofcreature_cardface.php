...
lore.classofcreature_cardface by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in classofcreature_cardface.php 

*/

class classofcreature_cardface extends DURCModel{

    

    
        // the datbase for this model
        protected $table = 'lore.classofcreature_cardface';
...
/**
*	get the single cardface for this classofcreature_cardface
*/
...
/**
*	get the single classofcreature for this classofcreature_cardface
*/
...
}//end of classofcreature_cardface