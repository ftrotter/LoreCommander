...
lore.classofc_cardface by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in classofc_cardface.php 

*/

class classofc_cardface extends DURCModel{

    

    
        // the datbase for this model
        protected $table = 'lore.classofc_cardface';
...
/**
*	get the single cardface for this classofc_cardface
*/
...
/**
*	get the single classofc for this classofc_cardface
*/
