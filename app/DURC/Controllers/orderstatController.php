...
class orderstatController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = orderstat::whereRaw($where_sql);
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_orderstat->id = $request->id;
        $tmp_orderstat->statusName = $request->statusName;
        ...
        return redirect("/DURC/orderstat/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_orderstat->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/orderstat/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, orderstat $orderstat){
	return($this->edit($request, $orderstat));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, orderstat $orderstat){
