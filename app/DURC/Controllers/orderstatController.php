...
class orderstatController extends DURCController
{
    ...
    */ 
	...
	$tmp_orderstat = $myNeworderstat;
			$tmp_orderstat->id = DURC::formatForStorage( 'id', 'tinyint', $request->id, $tmp_orderstat ); 
		$tmp_orderstat->statusName = DURC::formatForStorage( 'statusName', 'varchar', $request->statusName, $tmp_orderstat ); 
	...
	try {
	          ...
	          return redirect("/DURC/orderstat/create")->with('status', 'There was an error in your data: '.$e->getMessage());
    ...
    try {
	          ...
	          return redirect("/DURC/orderstat/{$id}")->with('status', 'There was an error in your data: '.$e->getMessage());
