...
class cardface_classofc_atagController extends DURCController
{
    ...
    */ 
	...
	$tmp_cardface_classofc_atag = $myNewcardface_classofc_atag;
			$tmp_cardface_classofc_atag->id = DURC::formatForStorage( 'id', 'int', $request->id ); 
		$tmp_cardface_classofc_atag->cardface_id = DURC::formatForStorage( 'cardface_id', 'int', $request->cardface_id ); 
		$tmp_cardface_classofc_atag->classofc_id = DURC::formatForStorage( 'classofc_id', 'int', $request->classofc_id ); 
