...
class cardface_classofc_atagController extends DURCController
{
    ...
    */ 
    ...
    public function edit(Request $request, cardface_classofc_atag $cardface_classofc_atag){
        ...
        if($cardface_classofc_atag->exists){	
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$cardface_classofc_atag = new cardface_classofc_atag();
		$params = $request->all(); //this will include GET and POST variables, etc
		$cardface_classofc_atag->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
