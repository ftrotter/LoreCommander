...
class purchaseorderdetailController extends DURCController
{
    ...
    */ 
	...
	$tmp_purchaseorderdetail = $myNewpurchaseorderdetail;
			$tmp_purchaseorderdetail->id = DURC::formatForStorage( 'id', 'int', $request->id, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->purchaseOrder_id = DURC::formatForStorage( 'purchaseOrder_id', 'int', $request->purchaseOrder_id, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->product_id = DURC::formatForStorage( 'product_id', 'int', $request->product_id, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->quantity = DURC::formatForStorage( 'quantity', 'decimal', $request->quantity, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->unitCost = DURC::formatForStorage( 'unitCost', 'decimal', $request->unitCost, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->dateReceived = DURC::formatForStorage( 'dateReceived', 'datetime', $request->dateReceived, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->postedToInventory = DURC::formatForStorage( 'postedToInventory', 'tinyint', $request->postedToInventory, $tmp_purchaseorderdetail ); 
		$tmp_purchaseorderdetail->inventory_id = DURC::formatForStorage( 'inventory_id', 'int', $request->inventory_id, $tmp_purchaseorderdetail ); 
	...
	try {
	          ...
	          return redirect("/DURC/purchaseorderdetail/create")->with('status', 'There was an error in your data: '.$e->getMessage());
    ...
    try {
	          ...
	          return redirect("/DURC/purchaseorderdetail/{$id}")->with('status', 'There was an error in your data: '.$e->getMessage());
