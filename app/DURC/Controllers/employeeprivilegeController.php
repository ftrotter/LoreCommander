...
class employeeprivilegeController extends DURCController
{
    ...
    */ 
	...
	return($this->edit($request, $employeeprivilege));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, employeeprivilege $employeeprivilege){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$employeeprivilege = new employeeprivilege();
		$params = $request->all(); //this will include GET and POST variables, etc
		$employeeprivilege->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
