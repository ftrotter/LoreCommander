    ...
    */ 
    ...
    public function edit(Request $request, classofc_cardface $classofc_cardface){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$classofc_cardface = new classofc_cardface();
		$params = $request->all(); //this will include GET and POST variables, etc
		$classofc_cardface->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
