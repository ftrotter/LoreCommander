...
class classofc_cardfaceController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_classofc_cardface->id = $request->id;
        $tmp_classofc_cardface->cardface_id = $request->cardface_id;
        $tmp_classofc_cardface->classofc_id = $request->classofc_id;
        ...
        return redirect("/DURC/classofc_cardface/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_classofc_cardface->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/classofc_cardface/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
	...
	return($this->edit($request, $classofc_cardface));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, classofc_cardface $classofc_cardface){
