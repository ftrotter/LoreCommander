    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/orderdetail/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_orderdetail->getErrors());
	...
	return($this->edit($request, $orderdetail));
    }
    ...
    public function jsonone(Request $request, $orderdetail_id){
		...
		if ($orderdetail === null) {
            return response()->json("orderdetail with id = {$orderdetail_id} Not Found", 404);
        }
		...
		$search_fields = \App\orderdetail::getSearchFields();
    ...
    public function edit(Request $request, orderdetail $orderdetail){
		...
		$orderdetail->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
