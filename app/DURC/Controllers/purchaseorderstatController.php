...
class purchaseorderstatController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = purchaseorderstat::whereRaw($where_sql);
    ...
    */ 
    ...
    public function edit(Request $request, purchaseorderstat $purchaseorderstat){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$purchaseorderstat = new purchaseorderstat();
		$params = $request->all(); //this will include GET and POST variables, etc
		$purchaseorderstat->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
