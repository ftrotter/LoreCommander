    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/nonprofitcorp/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_nonprofitcorp->getErrors());
	...
	return($this->edit($request, $nonprofitcorp));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, nonprofitcorp $nonprofitcorp){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$nonprofitcorp = new nonprofitcorp();
		$params = $request->all(); //this will include GET and POST variables, etc
		$nonprofitcorp->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
