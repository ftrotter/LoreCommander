    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/privilege/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_privilege->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/privilege/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
	...
	return($this->edit($request, $privilege));
    }
