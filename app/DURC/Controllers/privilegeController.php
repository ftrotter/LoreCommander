...
class privilegeController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = privilege::whereRaw($where_sql);
    ...
    */ 
	...
	$tmp_privilege = $myNewprivilege;
			$tmp_privilege->id = DURC::formatForStorage( 'id', 'int', $request->id, $tmp_privilege ); 
		$tmp_privilege->privilegeName = DURC::formatForStorage( 'privilegeName', 'varchar', $request->privilegeName, $tmp_privilege ); 
	...
	try {
	          ...
	          return redirect("/DURC/privilege/create")->with('status', 'There was an error in your data: '.$e->getMessage());
    ...
    try {
	          ...
	          return redirect("/DURC/privilege/{$id}")->with('status', 'There was an error in your data: '.$e->getMessage());
