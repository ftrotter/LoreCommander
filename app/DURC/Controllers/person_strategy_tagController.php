...
class person_strategy_tagController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_person_strategy_tag->id = $request->id;
        $tmp_person_strategy_tag->person_id = $request->person_id;
        $tmp_person_strategy_tag->strategy_id = $request->strategy_id;
        $tmp_person_strategy_tag->tag_id = $request->tag_id;
        $tmp_person_strategy_tag->is_bulk_linker = $request->is_bulk_linker;
        $tmp_person_strategy_tag->link_note = $request->link_note;
        ...
        return redirect("/DURC/person_strategy_tag/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_person_strategy_tag->getErrors());
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, person_strategy_tag $person_strategy_tag){
	return($this->edit($request, $person_strategy_tag));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, person_strategy_tag $person_strategy_tag){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$person_strategy_tag = new person_strategy_tag();
		$params = $request->all(); //this will include GET and POST variables, etc
		$person_strategy_tag->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
