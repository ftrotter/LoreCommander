...
class cardpriceController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = cardprice::whereRaw($where_sql);
    ...
    */ 
    ...
    public function jsonone(Request $request, $cardprice_id){
		...
		if ($cardprice === null) {
            return response()->json("cardprice with id = {$cardprice_id} Not Found", 404);
        }
		...
		$search_fields = \App\cardprice::getSearchFields();
    ...
    public function edit(Request $request, cardprice $cardprice){
		...
		$cardprice->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
