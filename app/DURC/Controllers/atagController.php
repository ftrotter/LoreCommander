...
class atagController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_atag->id = $request->id;
        $tmp_atag->arttag_name = $request->arttag_name;
        $tmp_atag->is_directed = $request->is_directed;
        $tmp_atag->excludes_arttag_id = $request->excludes_arttag_id;
        ...
        return redirect("/DURC/atag/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_atag->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/atag/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, atag $atag){
