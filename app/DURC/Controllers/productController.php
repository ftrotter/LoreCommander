...
class productController extends DURCController
{
    ...
    */ 
	...
	$tmp_product = $myNewproduct;
			$tmp_product->supplier_ids = DURC::formatForStorage( 'supplier_ids', 'longtext', $request->supplier_ids, $tmp_product ); 
		$tmp_product->id = DURC::formatForStorage( 'id', 'int', $request->id, $tmp_product ); 
		$tmp_product->productCode = DURC::formatForStorage( 'productCode', 'varchar', $request->productCode, $tmp_product ); 
		$tmp_product->productName = DURC::formatForStorage( 'productName', 'varchar', $request->productName, $tmp_product ); 
		$tmp_product->description = DURC::formatForStorage( 'description', 'longtext', $request->description, $tmp_product ); 
		$tmp_product->standardCost = DURC::formatForStorage( 'standardCost', 'decimal', $request->standardCost, $tmp_product ); 
		$tmp_product->listPrice = DURC::formatForStorage( 'listPrice', 'decimal', $request->listPrice, $tmp_product ); 
		$tmp_product->reorderLevel = DURC::formatForStorage( 'reorderLevel', 'int', $request->reorderLevel, $tmp_product ); 
		$tmp_product->targetLevel = DURC::formatForStorage( 'targetLevel', 'int', $request->targetLevel, $tmp_product ); 
		$tmp_product->quantityPerUnit = DURC::formatForStorage( 'quantityPerUnit', 'varchar', $request->quantityPerUnit, $tmp_product ); 
		$tmp_product->discontinued = DURC::formatForStorage( 'discontinued', 'tinyint', $request->discontinued, $tmp_product ); 
		$tmp_product->minimumReorderQuantity = DURC::formatForStorage( 'minimumReorderQuantity', 'int', $request->minimumReorderQuantity, $tmp_product ); 
		$tmp_product->category = DURC::formatForStorage( 'category', 'varchar', $request->category, $tmp_product ); 
		$tmp_product->attachments = DURC::formatForStorage( 'attachments', 'longblob', $request->attachments, $tmp_product ); 
	...
	try {
	          ...
	          return redirect("/DURC/product/create")->with('status', 'There was an error in your data: '.$e->getMessage());
    ...
    try {
	          ...
	          return redirect("/DURC/product/{$id}")->with('status', 'There was an error in your data: '.$e->getMessage());
