...
class mtgsetController extends DURCController
{
    ...
    */ 
	...
	$tmp_mtgset = $myNewmtgset;
		...
		$tmp_mtgset->scryfall_identifier = DURC::formatForStorage( 'scryfall_identifier', 'varchar', $request->scryfall_identifier ); 
		...
		$tmp_mtgset->parenth_set_code = DURC::formatForStorage( 'parenth_set_code', 'varchar', $request->parenth_set_code ); 
		...
		$tmp_mtgset->scryfall_url = DURC::formatForStorage( 'scryfall_url', 'varchar', $request->scryfall_url ); 
		$tmp_mtgset->set_url = DURC::formatForStorage( 'set_url', 'varchar', $request->set_url ); 
		$tmp_mtgset->icon_svg_url = DURC::formatForStorage( 'icon_svg_url', 'varchar', $request->icon_svg_url ); 
		$tmp_mtgset->search_url = DURC::formatForStorage( 'search_url', 'varchar', $request->search_url ); 
		$tmp_mtgset->save();
