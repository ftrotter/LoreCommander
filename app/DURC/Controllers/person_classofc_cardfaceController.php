...
class person_classofc_cardfaceController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_person_classofc_cardface->id = $request->id;
        $tmp_person_classofc_cardface->person_id = $request->person_id;
        $tmp_person_classofc_cardface->classofc_id = $request->classofc_id;
        $tmp_person_classofc_cardface->cardface_id = $request->cardface_id;
        $tmp_person_classofc_cardface->is_bulk_linker = $request->is_bulk_linker;
        $tmp_person_classofc_cardface->link_note = $request->link_note;
        ...
        return redirect("/DURC/person_classofc_cardface/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_person_classofc_cardface->getErrors());
	...
	return($this->edit($request, $person_classofc_cardface));
    }
    ...
    public function jsonone(Request $request, $person_classofc_cardface_id){
		...
		if ($person_classofc_cardface === null) {
            return response()->json("person_classofc_cardface with id = {$person_classofc_cardface_id} Not Found", 404);
        }
		...
		$search_fields = \App\person_classofc_cardface::getSearchFields();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, person_classofc_cardface $person_classofc_cardface){
        ...
        if($person_classofc_cardface->exists){	
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$person_classofc_cardface = new person_classofc_cardface();
		$params = $request->all(); //this will include GET and POST variables, etc
		$person_classofc_cardface->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
