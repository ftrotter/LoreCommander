...
class authorController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = author::whereRaw($where_sql);
    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/author/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_author->getErrors());
	...
	return($this->edit($request, $author));
    }
    ...
    public function edit(Request $request, author $author){
		...
		$author->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
