...
class classofc_classofc_vspackController extends DURCController
{
    ...
    */ 
    ...
    public function edit(Request $request, classofc_classofc_vspack $classofc_classofc_vspack){
        ...
        if($classofc_classofc_vspack->exists){	
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$classofc_classofc_vspack = new classofc_classofc_vspack();
		$params = $request->all(); //this will include GET and POST variables, etc
		$classofc_classofc_vspack->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
