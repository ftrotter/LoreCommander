...
class tagController extends DURCController
{
    ...
    */ 
    ...
    public function jsonone(Request $request, $tag_id){
		...
		$img_uri_field = \App\tag::getImgField();
		if(!is_null($img_uri_field)){ //then this object has an image link..
			if(!isset($return_me_array['card_img_top'])){ //allow the user to use this as a field without pestering..
				$return_me_array['card_img_top'] = $tag->$img_uri_field;
			}
		}
		...
		if(!isset($return_me_array['card_body'])){ //allow the user to use this as a field without pestering..
			...
			$return_me_array['card_body'] = $tag->getCardBody();
		}
    ...
    public function edit(Request $request, tag $tag){
		...
		$tag->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
