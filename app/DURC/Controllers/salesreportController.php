    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/salesreport/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_salesreport->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/salesreport/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
	...
	return($this->edit($request, $salesreport));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, salesreport $salesreport){
