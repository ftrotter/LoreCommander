...
class tags_reportController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = tags_report::whereRaw($where_sql);
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_tags_report->id = $request->id;
        $tmp_tags_report->field_to_bold_in_report_display = $request->field_to_bold_in_report_display;
        $tmp_tags_report->field_to_hide_by_default = $request->field_to_hide_by_default;
        $tmp_tags_report->field_to_italic_in_report_display = $request->field_to_italic_in_report_display;
        $tmp_tags_report->field_to_right_align_in_report = $request->field_to_right_align_in_report;
        $tmp_tags_report->field_to_bolditalic_in_report_display = $request->field_to_bolditalic_in_report_display;
        $tmp_tags_report->numeric_field = $request->numeric_field;
        $tmp_tags_report->decimal_field = $request->decimal_field;
        $tmp_tags_report->currency_field = $request->currency_field;
        $tmp_tags_report->percent_field = $request->percent_field;
        $tmp_tags_report->url_field = $request->url_field;
        $tmp_tags_report->time_field = $request->time_field;
        $tmp_tags_report->date_field = $request->date_field;
        $tmp_tags_report->datetime_field = $request->datetime_field;
        ...
        return redirect("/DURC/tags_report/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_tags_report->getErrors());
	...
	return($this->edit($request, $tags_report));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, tags_report $tags_report){
		...
		//we have to do this even if the object is new, because sometimes the variable is set from a GET or POST request... 
      		foreach($tags_report->toArray() as $key => $value){
       	 		...
       	 		if ($tags_report->isFieldNullable($key) &&
                		$input == null) {
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$tags_report = new tags_report();
		$params = $request->all(); //this will include GET and POST variables, etc
		$tags_report->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
