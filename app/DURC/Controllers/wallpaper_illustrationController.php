...
class wallpaper_illustrationController extends DURCController
{
    ...
    */ 
    ...
    public function edit(Request $request, wallpaper_illustration $wallpaper_illustration){
        ...
        if($wallpaper_illustration->exists){	
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$wallpaper_illustration = new wallpaper_illustration();
		$params = $request->all(); //this will include GET and POST variables, etc
		$wallpaper_illustration->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
