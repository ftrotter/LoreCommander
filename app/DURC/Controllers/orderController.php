...
class orderController extends DURCController
{
    ...
    */ 
    ...
    public function jsonone(Request $request, $order_id){
		...
		if ($order === null) {
            return response()->json("order with id = {$order_id} Not Found", 404);
        }
		...
		$search_fields = \App\order::getSearchFields();
    ...
    public function edit(Request $request, order $order){
		...
		$order->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
