...
class vspackController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = vspack::whereRaw($where_sql);
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_vspack->id = $request->id;
        $tmp_vspack->vspack_name = $request->vspack_name;
        $tmp_vspack->vspack_wizards_url = $request->vspack_wizards_url;
        $tmp_vspack->vspack_wiki_url = $request->vspack_wiki_url;
        $tmp_vspack->vspack_img_url = $request->vspack_img_url;
        ...
        return redirect("/DURC/vspack/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_vspack->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/vspack/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
	...
	return($this->edit($request, $vspack));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, vspack $vspack){
