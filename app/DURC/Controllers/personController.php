...
class personController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_person->id = $request->id;
        $tmp_person->last_name = $request->last_name;
        $tmp_person->first_name = $request->first_name;
        $tmp_person->person_blurb = $request->person_blurb;
        $tmp_person->image_uri = $request->image_uri;
        $tmp_person->wallpaper_download_url = $request->wallpaper_download_url;
        $tmp_person->mtgwiki_url = $request->mtgwiki_url;
        $tmp_person->wizards_story_url = $request->wizards_story_url;
        ...
        return redirect("/DURC/person/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_person->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/person/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
	...
	return($this->edit($request, $person));
    }
