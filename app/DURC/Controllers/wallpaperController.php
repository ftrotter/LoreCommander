...
class wallpaperController extends DURCController
{
    ...
    */ 
    ...
    public function jsonone(Request $request, $wallpaper_id){
		...
		if ($wallpaper === null) {
            return response()->json("wallpaper with id = {$wallpaper_id} Not Found", 404);
        }
		...
		$search_fields = \App\wallpaper::getSearchFields();
    ...
    public function edit(Request $request, wallpaper $wallpaper){
		...
		$wallpaper->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
