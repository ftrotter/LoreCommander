    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/appstring/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_appstring->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/appstring/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, appstring $appstring){
	return($this->edit($request, $appstring));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, appstring $appstring){
