...
class appstringController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = appstring::whereRaw($where_sql);
    ...
    */ 
	...
	$tmp_appstring = $myNewappstring;
			$tmp_appstring->id = DURC::formatForStorage( 'id', 'int', $request->id, $tmp_appstring ); 
		$tmp_appstring->stringData = DURC::formatForStorage( 'stringData', 'varchar', $request->stringData, $tmp_appstring ); 
	...
	try {
	          ...
	          return redirect("/DURC/appstring/create")->with('status', 'There was an error in your data: '.$e->getMessage());
    ...
    try {
	          ...
	          return redirect("/DURC/appstring/{$id}")->with('status', 'There was an error in your data: '.$e->getMessage());
