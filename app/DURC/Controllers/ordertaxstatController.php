    ...
    */ 
    ...
    public function edit(Request $request, ordertaxstat $ordertaxstat){
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$ordertaxstat = new ordertaxstat();
		$params = $request->all(); //this will include GET and POST variables, etc
		$ordertaxstat->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
