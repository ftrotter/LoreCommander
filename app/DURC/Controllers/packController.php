...
class packController extends DURCController
{
    ...
    */ 
    public function store(Request $request){
        ...
        $tmp_pack->id = $request->id;
        $tmp_pack->pack_name = $request->pack_name;
        $tmp_pack->pack_wizards_url = $request->pack_wizards_url;
        $tmp_pack->pack_wiki_url = $request->pack_wiki_url;
        $tmp_pack->pack_img_url = $request->pack_img_url;
        ...
        return redirect("/DURC/pack/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_pack->getErrors());

        } catch (\Exception $e) {
            return redirect("/DURC/pack/create")->withInput()->with('status', 'There was an error in your data: '.$e->getMessage());
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, pack $pack){
