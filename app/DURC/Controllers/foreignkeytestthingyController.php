...
class foreignkeytestthingyController extends DURCController
{
	...
	*/
   	public function search(Request $request){
		...
		$query = foreignkeytestthingy::whereRaw($where_sql);
    ...
    */ 
    public function store(Request $request){
        ...
        return redirect("/DURC/foreignkeytestthingy/$new_id")->with('status', 'Data Saved!');
            ...
            return back()->withInput()->with('errors', $tmp_foreignkeytestthingy->getErrors());
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, foreignkeytestthingy $foreignkeytestthingy){
	return($this->edit($request, $foreignkeytestthingy));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, foreignkeytestthingy $foreignkeytestthingy){
        ...
        if($foreignkeytestthingy->exists){	
		...
		//we have to do this even if the object is new, because sometimes the variable is set from a GET or POST request... 
      		foreach($foreignkeytestthingy->toArray() as $key => $value){
       	 		...
       	 		if ($foreignkeytestthingy->isFieldNullable($key) &&
                		$input == null) {
		...
		//this has not been saved yet, but we still want to honor GET and POST variables etc. 
        	$foreignkeytestthingy = new foreignkeytestthingy();
		$params = $request->all(); //this will include GET and POST variables, etc
		$foreignkeytestthingy->fill($params);  //this will initialize the contents of the object with anything in the GET etc.
