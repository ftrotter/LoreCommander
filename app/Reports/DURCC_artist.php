...
FILE_SIG=ffcef33931ebed7eda38630327ba006c
*/
namespace App\Reports;
use ftrotter\ZZermelo\Reports\Tabular\AbstractTabularReport;

class DURCC_artist extends AbstractTabularReport
{

    //returns the name of the report
    public function GetReportName(): string {
        $report_name = "artist Report";
        return($report_name);
    }

    //returns the description of the report. HTML is allowed here.
    public function GetReportDescription(): ?string {
        $desc = "View the artist data
			<br>
			<a href='/DURC/artist/create'>Add new artist</a>
";
        return($desc);
    }
	...
	$img_field_name = \App\artist::getImgField();
