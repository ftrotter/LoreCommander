...
FILE_SIG=b079f2d03df49680a8cf9d5155d43899
*/
namespace App\Reports;
use ftrotter\ZZermelo\Reports\Tabular\AbstractTabularReport;

class DURCC_mverse extends AbstractTabularReport
{

    //returns the name of the report
    public function GetReportName(): string {
        $report_name = "mverse Report";
        return($report_name);
    }

    //returns the description of the report. HTML is allowed here.
    public function GetReportDescription(): ?string {
        $desc = "View the mverse data
			<br>
			<a href='/DURC/mverse/create'>Add new mverse</a>
";
        return($desc);
    }
	...
	$img_field_name = \App\mverse::getImgField();
...
, mverse.updated_at AS updated_at
...
"; 
        ...
        $row['id'] = "<a href='/DURC/mverse/$id'>$id</a>";
