...
FILE_SIG=c489465e047fe7e497165db9d03546f2
*/
namespace App\Reports;
use ftrotter\ZZermelo\Reports\Tabular\AbstractTabularReport;

class DURCC_classofc extends AbstractTabularReport
{

    //returns the name of the report
    public function GetReportName(): string {
        $report_name = "classofc Report";
        return($report_name);
    }

    //returns the description of the report. HTML is allowed here.
    public function GetReportDescription(): ?string {
        $desc = "View the classofc data
			<br>
			<a href='/DURC/classofc/create'>Add new classofc</a>
";
        return($desc);
    }
	...
	$img_field_name = \App\classofc::getImgField();
...
classofc.id
$joined_select_field_sql 
, classofc.classofc_name AS classofc_name
, classofc.classofc_img_uri AS classofc_img_uri
, classofc.classofc_wiki_url AS classofc_wiki_url
, classofc.is_mega_class AS is_mega_class
, classofc.created_at AS created_at
, classofc.updated_at AS updated_at
...
";
	...
	$joined_select_field_sql  = '';
        ...
        $row['id'] = "<a href='/DURC/classofc/$id'>$id</a>";
...
array (
  ...
  'second_classofc_classofc_vspack' => 
  array (
    'prefix' => 'second',
    'type' => 'classofc_classofc_vspack',
    'from_table' => 'classofc_classofc_vspack',
    'from_db' => 'lore',
    'from_column' => 'second_classofc_id',
    'other_columns' => 
    array (
      0 => 
      array (
