...
class TEST_CharTest extends AbstractTabularReport
{
    ...
    */
	...
	$desc = "<p>
Databases have funny characters, this should not be a problem for Zermelo
</p>
";
	return($desc);
    }
