...
FILE_SIG=1ad0e2e4bffc897b9c725e3ac59edc48
*/
namespace App\Reports;
use ftrotter\ZZermelo\Reports\Tabular\AbstractTabularReport;

class DURCC_order_2019 extends AbstractTabularReport
{

    //returns the name of the report
    public function GetReportName(): string {
        $report_name = "order_2019 Report";
        return($report_name);
    }

    //returns the description of the report. HTML is allowed here.
    public function GetReportDescription(): ?string {
        $desc = "View the order_2019 data
			<br>
			<a href='/DURC/order_2019/create'>Add new order_2019</a>
";
        return($desc);
    }
	...
	$img_field_name = \App\order_2019::getImgField();
...
order_2019.id
$joined_select_field_sql 
, order_2019.employee_id AS employee_id
, order_2019.customer_id AS customer_id
, order_2019.orderDate AS orderDate
, order_2019.shippedDate AS shippedDate
, order_2019.shipper_id AS shipper_id
, order_2019.shipName AS shipName
, order_2019.shipAddress AS shipAddress
, order_2019.shipCity AS shipCity
, order_2019.shipStateProvince AS shipStateProvince
, order_2019.shipZipPostalCode AS shipZipPostalCode
, order_2019.shipCountryRegion AS shipCountryRegion
, order_2019.shippingFee AS shippingFee
, order_2019.taxes AS taxes
, order_2019.paymentType AS paymentType
, order_2019.paidDate AS paidDate
, order_2019.notes AS notes
, order_2019.taxRate AS taxRate
, order_2019.taxStatus_id AS taxStatus_id
, order_2019.status_id AS status_id

FROM DURC_northwind_data.order_2019

LEFT JOIN DURC_northwind_model.employee AS A_employee ON 
	A_employee.id =
	order_2019.employee_id

LEFT JOIN DURC_northwind_model.customer AS B_customer ON 
	B_customer.id =
	order_2019.customer_id

LEFT JOIN DURC_northwind_model.shipper AS C_shipper ON 
	C_shipper.id =
	order_2019.shipper_id
...
"; 
        ...
        $row['id'] = "<a href='/DURC/order_2019/$id'>$id</a>";
