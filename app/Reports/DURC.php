...
class DURC extends AbstractTabularReport
{
    // define the report name
    public function GetReportName(): string { return("Durc Main Report List"); }

    // define the report description, HTML is ok here.
    public function GetReportDescription(): ?string {
	$desc = "Lists all of the tables in the central database and links to their report, if there is one";
	return($desc);
    }
    ...
    **/
	...
	//TODO have the DURC Generator make this list automagically
	$db_list = [
		'lore',
		];

	$where_in = "TABLE_SCHEMA IN (";

	$c = '';
	foreach($db_list as $this_db){
		$where_in .= "$c '$this_db'";
		$c = ',';
	}
...
";
    ...
    */
	...
	if(file_exists(app_path() . "/Reports/DURC_$table_name.php")){
		$row['table_name'] = "<a href='/Zermelo/DURC_$table_name/'>$table_name</a>";
	}
