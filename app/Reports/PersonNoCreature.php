...
class PersonNoCreature extends AbstractTabularReport
{
    ...
    */
	...
	return("People without creature affilations");
    }
    ...
    */
	...
	$desc = "These are MTG characters who currently have no affilation with high-level class of creatures"; 
	return($desc);
    }
