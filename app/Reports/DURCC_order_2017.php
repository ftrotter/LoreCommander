...
FILE_SIG=f44953a8893a5e709b3b62d49f2bd033
*/
namespace App\Reports;
use ftrotter\ZZermelo\Reports\Tabular\AbstractTabularReport;

class DURCC_order_2017 extends AbstractTabularReport
{

    //returns the name of the report
    public function GetReportName(): string {
        $report_name = "order_2017 Report";
        return($report_name);
    }

    //returns the description of the report. HTML is allowed here.
    public function GetReportDescription(): ?string {
        $desc = "View the order_2017 data
			<br>
			<a href='/DURC/order_2017/create'>Add new order_2017</a>
";
        return($desc);
    }
	...
	$img_field_name = \App\order_2017::getImgField();
...
order_2017.id
$joined_select_field_sql 
, order_2017.employee_id AS employee_id
, order_2017.customer_id AS customer_id
, order_2017.orderDate AS orderDate
, order_2017.shippedDate AS shippedDate
, order_2017.shipper_id AS shipper_id
, order_2017.shipName AS shipName
, order_2017.shipAddress AS shipAddress
, order_2017.shipCity AS shipCity
, order_2017.shipStateProvince AS shipStateProvince
, order_2017.shipZipPostalCode AS shipZipPostalCode
, order_2017.shipCountryRegion AS shipCountryRegion
, order_2017.shippingFee AS shippingFee
, order_2017.taxes AS taxes
, order_2017.paymentType AS paymentType
, order_2017.paidDate AS paidDate
, order_2017.notes AS notes
, order_2017.taxRate AS taxRate
, order_2017.taxStatus_id AS taxStatus_id
, order_2017.status_id AS status_id

FROM DURC_northwind_data.order_2017

LEFT JOIN DURC_northwind_model.employee AS A_employee ON 
	A_employee.id =
	order_2017.employee_id

LEFT JOIN DURC_northwind_model.customer AS B_customer ON 
	B_customer.id =
	order_2017.customer_id

LEFT JOIN DURC_northwind_model.shipper AS C_shipper ON 
	C_shipper.id =
	order_2017.shipper_id
...
"; 
        ...
        $row['id'] = "<a href='/DURC/order_2017/$id'>$id</a>";
