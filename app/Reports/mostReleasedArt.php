...
class mostReleasedArt extends AbstractTabularReport
{
    ...
    public function GetReportName(): string { return("Most Released Art"); }

    public function GetReportDescription(): string {
    // define the report description, HTML is ok here.
	$desc = "Sometimes a specific illustration is used over and over, for the same card over many core and expansion sets. These are the longest-lasting illustrations in MTG.";
	return($desc);
    }
...
JOIN lore.mtgset ON 
	...
	card.mtgset_id
WHERE 
	type_line NOT LIKE '%Basic Land%' AND 
