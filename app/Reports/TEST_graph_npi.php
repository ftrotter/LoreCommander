...
class TEST_graph_npi extends AbstractGraphReport
{
    ...
    */
    ...
    public function GetSQL()
    {
        $sql = "
SELECT
`from_npi` AS source_id,
`from_npi` AS source_name,
100 AS source_size,
'npi' AS source_type,
'this_group' AS source_group,
...
`to_npi` AS target_id,
`to_npi` AS target_name,
100 AS target_size,
'npi' AS target_type,
'this_group' AS target_group,
...
";
    ...
    */
    ...
    {
        return("Test the Graph Report Engine");;
    }
