...
DURC_northwind_data.order_2019 by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in order_2019.php 

*/

class order_2019 extends DURCModel {
	 ...
	 //not auditable, configured using is_auditable = 0 in config json
        ...
        protected $table = 'DURC_northwind_data.order_2019';
...
/**
*	get the single employee for this order_2019
*/
...
/**
*	get the single customer for this order_2019
*/
...
/**
*	get the single shipper for this order_2019
*/
...
/*
CREATE TABLE `DURC_northwind_data`.`order_2019` (
