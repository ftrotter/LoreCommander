...
DURC_northwind_data.order_2018 by DURC.

	This class will be overwritten during future auto-generation runs..
	Itjust reflects whatever is in the database..
	DO NOT EDIT THIS FILE BY HAND!!
	Your changes go in order_2018.php 

*/

class order_2018 extends DURCModel {
	 ...
	 //not auditable, configured using is_auditable = 0 in config json
        ...
        protected $table = 'DURC_northwind_data.order_2018';
...
/**
*	get the single employee for this order_2018
*/
...
/**
*	get the single customer for this order_2018
*/
...
/**
*	get the single shipper for this order_2018
*/
...
/*
CREATE TABLE `DURC_northwind_data`.`order_2018` (
