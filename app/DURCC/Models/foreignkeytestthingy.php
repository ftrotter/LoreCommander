...
DURC_aaa.foreignkeytestthingy by DURC.
...
class foreignkeytestthingy extends DURCModel {
    ...
    use SoftDeletes;
        ...
        protected $table = 'DURC_aaa.foreignkeytestthingy';
    ...
    protected static $rules = [
		'thingyname' => 'required',
		'gizmopickupaskey' => 'integer|required',
		'created_at' => 'required',
		'updated_at' => 'required',
		'deleted_at' => 'required',
...
/*
CREATE TABLE `DURC_aaa`.`foreignkeytestthingy` (
