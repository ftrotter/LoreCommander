...
FILE_SIG=6443a1124e2184c7cb5ade7cca901051
*/
...
class siblingController extends DURCParentController
{
    ...
    public function show(Request $request, sibling $sibling){
        // enter your stuff here if you want...
	return(parent::show($request, $sibling));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, sibling $sibling, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($request, $sibling));
    }
