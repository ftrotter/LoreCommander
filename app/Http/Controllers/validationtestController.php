...
FILE_SIG=1fbefe7c6bcb1254ce3e3365f6617d17
*/
...
class validationtestController extends DURCParentController
{
    ...
    public function show(Request $request, validationtest $validationtest){
        // enter your stuff here if you want...
	return(parent::show($request, $validationtest));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, validationtest $validationtest, $is_new = false){
        // enter your stuff here if you want...
	return(parent::edit($request, $validationtest));
    }
    ...
    public function update(Request $request, validationtest $validationtest){
        // enter your stuff here if you want...
	return(parent::update($request,$validationtest));
    }
    ...
    public function destroy(validationtest $validationtest){
        // enter your stuff here if you want...
	return(parent::destroy($validationtest));
    }
