<?php
	...
	foreach($databases as $this_db){
		...
		$commands[] = "psql -h db -U postgres -d lorecommander -c \"CREATE SCHEMA IF NOT EXISTS $this_db\"";
		$commands[] = "psql -h db -U postgres -d lorecommander -c \"SET search_path TO $this_db;\" < $this_db.sql";
	}
	...
	foreach($commands as $this_command){
		...
		echo "Running\n$safe_print_command\n";
		system("PGPASSWORD=$password $this_command");
	}
